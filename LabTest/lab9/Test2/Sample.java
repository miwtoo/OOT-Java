...
public class Sample {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            catch(LengthNotMatchException e){
                System.out.println(e.getMessage());
            }
            catch(InterphoneException e){
                System.out.println(e.getMessage());
            }
    ...
    public static void validate(String name,String tel) throws NonDigitException, LengthNotMatchException{
         ...
         else if(getInerPhone(tel))
            throw new InterphoneException(name + " phone have an inter phone");
    ...
    public static boolean getInerPhone(String tel){
        for (int i = 0; i < tel.length(); i++) {
            char ch = tel.charAt(i);
            if(ch == '+')
                return true;
